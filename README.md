...
## 🚀 Overview  
This is an opensource project to build a self balancing skateboard that uses a large single brushless hub motor
It was featured on my [YouTube channel](https://www.youtube.com/@ByteSizedEngineering) in [this video](https://youtube.com/playlist?list=PL8Udln1nmXVDxgmHgm5FxP8XWh-Dkr9C5). 
...
## 🎥 Video & More Info  
📺 Watch the full build video: [YouTube Video](https://youtube.com/playlist?list=PL8Udln1nmXVDxgmHgm5FxP8XWh-Dkr9C5)  
